...
func (r *PostgresRepository) Begin(ctx context.Context) (context.Context, error) {
...
func (r *PostgresRepository) Commit(ctx context.Context) error {
...
func (r *PostgresRepository) Rollback(ctx context.Context) error {
	tx, ok := ctx.Value(TxKey{}).(*sqlx.Tx)
	if !ok {
		return nil
	}
...
func (r *PostgresRepository) getTx(ctx context.Context) (tx *sqlx.Tx, isNew bool, err error) {
...
func (r *PostgresRepository) LinkChatToProject(ctx context.Context, chatID int64, projectID uuid.UUID) error {
...
func (r *PostgresRepository) GetProjectByChatID(ctx context.Context, chatID int64) (uuid.UUID, error) {
...
func (r *PostgresRepository) SaveMessage(ctx context.Context, message message.Message) error {
